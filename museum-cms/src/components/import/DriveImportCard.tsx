...
//   const { initiateDriveImport, runImport, importing, progress, result, error, reset } = useDriveImport();
...
//       console.log("Found code and saved ID. Starting import...");
//       // Remove 'code' from URL so it doesn't trigger again
...
//         <h3 style={{ fontSize: 18, fontWeight: 600 }}>Google Drive Import</h3>
//       </div>
...
//             style={{ padding: "12px", background: "var(--background)", border: "1px solid var(--border)", color: "var(--text)", borderRadius: 8 }}
//           />
//           <Button onClick={handleConnect} disabled={!folderIdInput}>Connect & Import</Button>
//         </div>
//       )}
...
//           <Spinner size="lg" />
//           <p style={{ marginTop: 12 }}>{progress?.stage || "Processing..."}</p>
//         </div>
//       )}

//       {result && (
//         <div style={{ textAlign: "center" }}>
//           <Check size={40} color="#34A853" />
//           <p>Imported {result.stats.new} items!</p>
//           <Button onClick={reset} variant="secondary">Done</Button>
//         </div>
//       )}

//       {error && (
//         <div style={{ color: "#B8392E", marginTop: 12 }}>
//           <X size={16} /> {error}
